...
Defines visual animation behaviors for card selection, card matching/pairing, invalid pair attempts, game victory celebrations, and game loss pyramid collapse.
