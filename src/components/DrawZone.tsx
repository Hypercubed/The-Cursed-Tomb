    ...
    <div className="flex flex-row gap-8 items-start pt-4">
      ...
      <div>
        ...
        >
          ...
          <span className="font-bold text-[0.6rem] tracking-wider uppercase mb-1">{drawButtonLabel}</span>
        </button>
      ...
      <div>
        ...
        {topDiscard !== null ? (
          <div className={`rounded-xl transition-all duration-[120ms] ${selectedCardId === topDiscard.id ? 'p-[2px] bg-gradient-to-r from-game-accent to-game-accent-light shadow-[0_0_12px_rgba(217,119,6,0.35)]' : ''}`}>
            <PlayingCard
          ...
          <div className="w-[72px] min-h-[96px] rounded-xl border border-dashed border-game-border flex flex-col items-center justify-center text-game-muted text-xs bg-[#100c08] shadow-[inset_0_0_8px_rgba(0,0,0,0.8)] relative">
