...
export function CampaignEndModal({
  ...
  return (
    ...
    >
      <div
        className="bg-[#18130e] border-2 border-[#3d3124] rounded-xl max-w-lg w-full flex flex-col max-h-[calc(100svh-1rem)] sm:max-h-[90vh] shadow-[0_10px_35px_rgba(0,0,0,0.9)] overflow-hidden"
      ...
      >
        ...
        {/* Modal Body */}
        <div className="p-3 sm:p-6 flex-1 overflow-y-auto flex flex-col gap-4 sm:gap-6 text-sm">
