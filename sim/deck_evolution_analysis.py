...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--solver", choices=["greedy", "heuristic", "beam", "dfs", "novice"], default="greedy", help="Campaign solver strategy (default: greedy)")
    parser.add_argument("--probe-solver", choices=["greedy", "heuristic", "beam", "dfs", "novice"], default="greedy", help="Oracle probe solver strategy (default: greedy)")
